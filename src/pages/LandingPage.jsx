...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen w-full bg-cyber-bg text-cyber-text overflow-x-hidden">
        {/* Loading overlay */}
        <div className={`fixed inset-0 z-50 bg-black flex items-center justify-center transition-opacity duration-500 ${bgLoaded ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          <div className="text-cyber-primary text-2xl font-mono">
        ...
        <div className="fixed inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-cyber-bg via-cyber-neutral/30 to-cyber-secondary/20"></div>

          {/* Futuristic cityscape silhouette */}
          <div className="absolute inset-0 bg-gradient-to-t from-cyber-bg via-transparent to-cyber-bg/60"></div>
          <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-cyber-neutral/40 via-cyber-primary/20 to-transparent"></div>
          
          {/* Dynamic grid system */}
          <div className="absolute inset-0 opacity-30">
            <div className="absolute inset-0 bg-[linear-gradient(rgba(255,78,255,0.2)_1px,transparent_1px),linear-gradient(90deg,rgba(255,78,255,0.2)_1px,transparent_1px)] bg-[size:40px_40px] animate-pulse"></div>
            <div className="absolute inset-0 bg-[linear-gradient(rgba(255,105,180,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,105,180,0.1)_1px,transparent_1px)] bg-[size:80px_80px] animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
          ...
          <div className="absolute inset-0 overflow-hidden">
            {Array.from({ length: 3 }).map((_, i) => (
                ...
                className="absolute rounded-full animate-pulse"
                  ...
                  width: `${200 + i * 100}px`,
                  height: `${200 + i * 100}px`,
                  background: `radial-gradient(circle, rgba(255, 78, 255, 0.1) 0%, rgba(255, 78, 255, 0.05) 50%, transparent 100%)`,
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                  <span className="bg-gradient-to-r from-cyber-primary via-cyber-secondary to-cyber-glow bg-clip-text text-transparent">
                    Lexie:
                  </span>
                  <br />
                ...
                <p className="text-xl text-cyber-text-secondary max-w-lg">
              ...
              rel="noopener noreferrer"
                  className="px-8 py-4 bg-gradient-to-r from-cyber-primary to-cyber-secondary text-cyber-bg font-semibold rounded-lg hover:from-cyber-secondary hover:to-cyber-glow transition-all duration-300 shadow-cyber hover:shadow-cyber-hover hover:scale-105 text-center"
            >
                  Join Telegram
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
                  className="px-8 py-4 bg-gradient-to-r from-cyber-neutral to-cyber-primary text-cyber-text font-semibold rounded-lg hover:from-cyber-primary hover:to-cyber-secondary transition-all duration-300 shadow-cyber hover:shadow-cyber-hover hover:scale-105 text-center"
            >
                  Join Twitter
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
                    className="px-8 py-4 border-2 border-cyber-primary text-cyber-primary font-semibold rounded-lg hover:bg-cyber-primary hover:text-cyber-bg transition-all duration-300 hover:scale-105 text-center hover:shadow-cyber"
            >
                    Launch Beta
            </a>
          </div>
            ...
            <div className="relative flex justify-center">
              ...
              <div className="relative bg-cyber-neutral rounded-lg border border-cyber-primary/50 shadow-cyber overflow-hidden max-w-lg w-full">
                {/* Terminal Header */}
                <div className="flex items-center justify-between bg-cyber-bg px-4 py-3 border-b border-cyber-primary/50">
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                    <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                    <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span className="text-cyber-text-secondary ml-4 font-mono text-sm">lexie-ai</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-cyber-secondary rounded-full animate-pulse"></div>
                      <span className="text-cyber-secondary text-xs font-mono">ONLINE</span>
                    </div>
                  </div>
                </div>
          
                {/* Terminal Body with Avatar */}
                                <div className="bg-cyber-bg px-8 pt-4 pb-0 relative h-90 flex items-center justify-center">
                  ...
                  <div className={`absolute top-4 left-4 font-mono text-xs text-green-400 pointer-events-none z-0 transition-opacity duration-1000 ${imageVisible ? 'opacity-80' : 'opacity-0'}`}>
                    {bootSequenceLines.map((line, index) => (
                      <div 
                        key={index} 
                        className={`mb-1 ${
                          line.startsWith('✓') ? 'text-cyber-secondary' :
                          line.includes('OPERATIONAL') ? 'text-cyber-secondary font-bold' :
                          line.includes('BOOT') ? 'text-cyber-primary' :
                          'text-cyber-glow'
                        }`}
                      >
                        {line}
                          ...
                          {line === 'Ready for commands...' && (
                            <span className="text-cyber-secondary animate-pulse" style={{animationDuration: '2s', fontSize: '9px'}}>█</span>
                          )}
                      </div>
                    ))}
                    {bootIsTyping && bootCurrentLine < bootSequenceTerminalLines.length && (
                      <span className="animate-pulse text-cyber-secondary">█</span>
                    )}
                  </div>
                  ...
                  {/* Holographic effect */}
                  <div className="absolute inset-0 bg-gradient-to-t from-cyber-primary/20 via-transparent to-cyber-secondary/20 blur-sm"></div>
                </div>

                {/* Terminal Footer */}
                <div className="bg-cyber-bg px-4 py-2 border-t border-cyber-primary/50">
                  <div className="flex items-center justify-between text-xs text-cyber-text-secondary">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-cyber-secondary">Connected</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative z-30 py-20 bg-gradient-to-b from-cyber-bg via-cyber-neutral/50 to-cyber-bg">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-cyber-text mb-4">
              Watch Lexie in <span className="text-cyber-primary">Action</span>
            </h2>
          ...
          {/* Main Terminal */}
          <div className="relative bg-cyber-neutral rounded-lg border border-cyber-primary/50 shadow-cyber overflow-hidden">
            {/* Terminal Header */}
            <div className="flex items-center justify-between bg-cyber-bg px-4 py-3 border-b border-cyber-primary/50">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-cyber-text-secondary ml-4 font-mono text-sm">lexie-ai-terminal</span>
              </div>
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-cyber-secondary rounded-full animate-pulse"></div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-cyber-primary text-xs font-mono">SECURE</span>
                </div>
              </div>
            </div>

            {/* Terminal Body */}
            <div className="bg-cyber-bg p-6 font-mono text-sm leading-relaxed h-[480px] overflow-hidden">
      ...
      <section id="features" className="relative z-30 py-32 overflow-hidden">
        {/* Section Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-cyber-primary/10 via-cyber-bg/50 to-cyber-secondary/10"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-bold text-cyber-text mb-6">
              <span className="bg-gradient-to-r from-cyber-primary via-cyber-secondary to-cyber-glow bg-clip-text text-transparent">
                LEXIE PLATFORM
              </span>
            </h2>
          ...
          <div className="relative flex items-center">
            ...
            <div className="hidden md:flex flex-shrink-0 mr-6">
              <button
                ...
                className="flex items-center space-x-2 bg-cyber-bg/80 backdrop-blur-sm border border-cyber-primary/40 rounded-full px-4 py-2 hover:border-cyber-primary/80 hover:bg-cyber-primary/20 transition-all duration-300 cursor-pointer group"
              >
                <svg className="w-5 h-5 text-cyber-primary group-hover:text-cyber-glow transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
                <span className="text-cyber-primary text-sm font-mono group-hover:text-cyber-glow">SCROLL</span>
              </button>
            </div>
            ...
            <div className="flex-1 overflow-hidden">
              <div ref={carouselRef} className="flex space-x-4 md:space-x-8 pb-8 overflow-x-auto scrollbar-hide snap-x snap-mandatory" style={{scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitOverflowScrolling: 'touch'}}>
                ...
                >
                  {/* Main Panel */}
                  <div className="relative h-full bg-cyber-bg/60 backdrop-blur-sm border border-cyber-primary/30 rounded-xl p-4 sm:p-6 overflow-hidden transition-all duration-500 hover:border-cyber-primary/80 hover:shadow-cyber hover:shadow-cyber-hover sm:group-hover:scale-105">

                    {/* Background Glow Effect */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-br from-cyber-primary/5 via-transparent to-cyber-primary/10"></div>
                    
                    {/* Panel Header */}
                    <div className="relative z-10 flex items-center justify-between mb-3 sm:mb-4">
                      <div className="text-2xl sm:text-3xl p-1.5 sm:p-2 rounded-lg bg-cyber-primary/20">
                        {feature.icon}
                      </div>
                      <div className="px-2 py-1 rounded text-xs font-mono border border-cyber-primary/40 bg-cyber-primary/20 text-cyber-primary">
                        {feature.status}
                      </div>
                    </div>
                    ...
                    <div className="relative z-10 mb-2 sm:mb-3">
                      <div className="text-xs font-mono text-cyber-text-secondary mb-1">// MISSION_TYPE:</div>
                      <div className="font-mono font-semibold text-xs sm:text-sm tracking-wider text-cyber-primary">
                        {feature.missionType}
                      </div>
                    </div>

                    {/* Title */}
                    <h3 className="relative z-10 text-lg sm:text-xl font-bold text-cyber-text mb-3 sm:mb-4 group-hover:text-cyber-primary transition-colors duration-300">
                      {feature.title}
                    </h3>

                    {/* Description */}
                    <p className="relative z-10 text-cyber-text-secondary text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6 group-hover:text-cyber-text transition-colors duration-300">
                      {feature.description}
                    </p>
                    ...
                    <div className="relative z-10 mt-auto">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs font-mono text-cyber-text-secondary">EFFICIENCY</span>
                        <span className="text-xs font-mono text-cyber-primary">{feature.efficiency}</span>
                      </div>
                      <div className="w-full bg-cyber-neutral rounded-full h-1.5">
                        <div
                          className="h-1.5 bg-gradient-to-r from-cyber-primary to-cyber-secondary rounded-full transition-all duration-1000 group-hover:animate-pulse"
                    ...
                    {/* Corner Accents */}
                    <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-cyber-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="absolute top-2 right-2 w-4 h-4 border-r-2 border-t-2 border-cyber-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="absolute bottom-2 left-2 w-4 h-4 border-l-2 border-b-2 border-cyber-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-cyber-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </div>

                  {/* Floating Connection Lines */}
                  <div className="absolute -bottom-4 left-1/2 w-px h-8 bg-gradient-to-b from-cyber-primary/50 to-transparent transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </div>
                  ));
                }).flat()}
              </div>
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 cursor-pointer hover:scale-125 ${
                  activeCardIndex === i
                    ? 'bg-cyber-primary w-3 h-3'
                    : 'bg-cyber-primary/40 hover:bg-cyber-primary'
                }`}
      ...
      {/* Why Lexie Section */}
      <section className="relative z-30 py-20 bg-gradient-to-r from-cyber-primary/20 to-cyber-secondary/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl lg:text-5xl font-bold text-cyber-text">
                Why <span className="text-cyber-primary">Lexie</span>?
              </h2>
              <div className="space-y-4 text-lg text-cyber-text-secondary">
                <p>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 text-cyber-secondary">
                  <div className="w-2 h-2 bg-cyber-secondary rounded-full animate-pulse"></div>
                  <span className="font-mono text-sm">Neural network: ACTIVE</span>
                </div>
                <div className="flex items-center space-x-3 text-cyber-primary">
                  <div className="w-2 h-2 bg-cyber-primary rounded-full animate-pulse"></div>
                  <span className="font-mono text-sm">Market analysis: RUNNING</span>
                </div>
                <div className="flex items-center space-x-3 text-cyber-glow">
            ...
            <div className="bg-cyber-bg/60 border border-cyber-primary/30 rounded-lg p-6 font-mono text-sm">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-cyber-text-secondary ml-2">ai.logs</span>
              </div>
      ...
      <section id="security" className="relative z-30 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-cyber-text mb-4">
              Security & <span className="text-cyber-primary">Privacy First</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-cyber-bg/40 backdrop-blur-sm border border-cyber-primary/30 rounded-xl p-8 text-center hover:border-cyber-primary/60 transition-all duration-300">
              <div className="text-4xl mb-4">🔐</div>
              <h3 className="text-xl font-semibold text-cyber-text mb-3">Zero-Knowledge Transactions</h3>
            ...
            <div className="bg-cyber-bg/40 backdrop-blur-sm border border-cyber-secondary/30 rounded-xl p-8 text-center hover:border-cyber-secondary/60 transition-all duration-300">
              <div className="text-4xl mb-4">🔑</div>
              <h3 className="text-xl font-semibold text-cyber-text mb-3">Key Sharding</h3>
              <p className="text-cyber-text-secondary">
            ...
            <div className="bg-cyber-bg/40 backdrop-blur-sm border border-cyber-glow/30 rounded-xl p-8 text-center hover:border-cyber-glow/60 transition-all duration-300">
              <div className="text-4xl mb-4">🛡️</div>
              <h3 className="text-xl font-semibold text-cyber-text mb-3">HMAC-Secured</h3>
              <p className="text-cyber-text-secondary">
          ...
          {/* Security metrics */}
          <div className="mt-16 bg-gradient-to-r from-cyber-primary/30 to-cyber-secondary/30 rounded-2xl p-8">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold text-cyber-primary mb-2">256-bit</div>
                <div className="text-cyber-text-secondary">Encryption</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-cyber-secondary mb-2">99.9%</div>
                <div className="text-cyber-text-secondary">Uptime</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-cyber-glow mb-2">0</div>
                <div className="text-cyber-text-secondary">Breaches</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-cyber-primary mb-2">24/7</div>
                <div className="text-cyber-text-secondary">Monitoring</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Final CTA Section */}
      <section id="beta" className="relative z-30 py-20 bg-gradient-to-t from-cyber-primary/40 to-transparent">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="space-y-8">
            <h2 className="text-4xl lg:text-6xl font-bold text-cyber-text">
              Ready to Experience the
              <span className="block text-transparent bg-gradient-to-r from-cyber-primary to-cyber-secondary bg-clip-text">
                Future of DeFi?
              </span>
            </h2>
            {/* Beta status indicator */}
            <div className="inline-flex items-center space-x-2 bg-cyber-secondary/20 border border-cyber-secondary/30 rounded-full px-6 py-3">
              <div className="w-3 h-3 bg-cyber-secondary rounded-full animate-pulse"></div>
              <span className="text-cyber-secondary font-semibold">Beta Access Available</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group px-8 py-4 bg-gradient-to-r from-cyber-primary to-cyber-secondary text-cyber-bg font-semibold text-base rounded-full hover:from-cyber-secondary hover:to-cyber-glow transition-all duration-300 shadow-cyber hover:shadow-cyber-hover hover:scale-105 flex items-center space-x-2"
              >
                <span>🚀</span>
                <span>Join Beta</span>
              </a>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-4 border-2 border-cyber-glow text-cyber-glow rounded-full hover:bg-cyber-glow hover:text-cyber-bg transition-all duration-300 hover:scale-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-4 border-2 border-cyber-primary text-cyber-primary rounded-full hover:bg-cyber-primary hover:text-cyber-bg transition-all duration-300 hover:scale-110"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="mailto:lexie@lexiecrypto.com"
                  className="p-4 border-2 border-cyber-secondary text-cyber-secondary rounded-full hover:bg-cyber-secondary hover:text-cyber-bg transition-all duration-300 hover:scale-110"
          >
      ...
      {/* Footer */}
      <footer className="relative z-30 py-12 border-t border-cyber-primary/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <div className="text-2xl font-bold text-cyber-primary mb-2">LEXIEAI</div>
              <p className="text-cyber-text-secondary">
                Trade smarter. Quest deeper. Stay private.
              </p>
            </div>
            ...
            <div className="flex space-x-6">
              <a href="#features" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Features</a>
              <a href="#security" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Security</a>
              <a href="#beta" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Beta</a>
              <a href="/t&cs" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Terms & Conditions</a>
              <a href="/privacy" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Privacy Policy</a>
              <a href="mailto:lexie@lexiecrypto.com" className="text-cyber-text-secondary hover:text-cyber-primary transition-colors">Contact</a>
            </div>
          </div>

          <div className="mt-8 pt-8 border-t border-cyber-neutral text-center text-cyber-text-secondary">
