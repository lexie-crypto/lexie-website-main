              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <div className="space-y-4 ml-4">
                    ...
                    <div>
                      <strong className="text-white">Lexie ID and Telegram ID</strong> – If you choose to create a Lexie ID or link your Telegram account, we may collect your chosen username and associated Telegram identifier. This allows us to provide the Lexie ID service, process referrals and enable social interactions.
                    </div>
                    <div>
                    ...
                    <div>
                      <strong className="text-white">Referral Information</strong> – We may collect the Lexie ID of the person who referred you and any points or rewards associated with the referral.
                    </div>
                  </div>
                  ...
                  <p>We integrate third‑party services into the Services, such as Cloudflare for performance and security, remote procedure call (RPC) providers to interact with specific blockchains, analytics providers and mailing services (e.g., Beehiiv). These partners may collect certain information (such as IP addresses or device information) necessary to deliver their services. We recommend reviewing the privacy policies of these providers. Lexie is not responsible for the data practices of third parties.</p>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-3 ml-4">
                    <div>
                      <strong className="text-white">Providing and Operating the Services</strong> – To create and maintain your Lexie Vault, issue Lexie IDs, process transactions and maintain your LexiePoints balance. This includes using wallet addresses and Lexie IDs to execute transfers and referrals. Uniswap, for example, uses data to provide, maintain and customize its services.
                    </div>
                    <div>
                    ...
                    <div>
                      <strong className="text-white">Marketing and Communication</strong> – If you subscribe to our newsletter or other updates, we may send you information about Lexie products, services and features. You can opt out at any time.
                    </div>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <p className="mb-3">Lexie does not sell your personal information. We may share data in the following circumstances:</p>
                  <div className="space-y-3 ml-4">
                    <div>
                    ...
                    <div>
                      <strong className="text-white">Legal and Compliance</strong> – We may disclose information when required by law, regulation or legal process; to comply with our obligations; to protect the safety, rights or property of Lexie, our users or others; or to investigate fraud or wrongdoing.
                    </div>
                    <div>
