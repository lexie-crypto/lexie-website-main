...
const VaultDesktopInner = () => {
  ...
  useEffect(() => {
    const markDone = () => {
      ...
      // Auto-show LexieID setup modal when wallet is created
      if (showSignRequestPopup) {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white overflow-x-hidden">
      ...
      {/* LexieID Setup Window */}
      {showLexieModal && (
        <WindowShell
          id="lexie-id-setup-terminal"
          title="lexie-id-setup"
          appType="setup"
          statusLabel="Setup"
          statusTone="success"
          footerLeft="Process: lexie-id-setup"
          footerRight={`@lex:${currentLexieId || 'none'}`}
          variant="setup"
          onClose={() => {
          ...
          className="z-[99]"
        >
          <div className="h-full w-full bg-black text-green-300 font-mono overflow-auto scrollbar-terminal p-6 space-y-4">
            <div>
            ...
            {canUseRailgun && railgunAddress ? (
              <div className="space-y-4">
                <div className="bg-gray-900/40 border border-green-500/20 rounded p-3">
